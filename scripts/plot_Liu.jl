...
prob = ODEProblem(neur, Pair[], (0.0, 500.0) )
...
p = plot(layout=(10,1), size=(1200,2000))
#plot!(p, sol, idxs=[neur.Na.conductance.m, neur.Na.conductance.h], subplot=1)
...
plot!(p, sol, idxs=[neur.soma.ca.i], subplot=10)
gui(p)
