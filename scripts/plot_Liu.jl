...
p = plot(sol, idxs=[neur.Na.conductance.m, neur.Na.conductance.h], layout=(7,1), size=(1200,2000), subplot=1)
...
plot!(p, sol, idxs=[neur.soma.v], subplot=5)
plot!(p, sol, idxs=[neur.soma.Ca], subplot=6)
plot!(p, sol, idxs=[neur.soma.ca.i], subplot=7)
gui(p)
